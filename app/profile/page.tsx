...
export default function ProfileForm() {
  ...
  useEffect(() => {
    const value = localStorage.getItem("my_profile");
    if (value) {
        ...
        <form className="space-y-4" onSubmit={handleSubmit}>
          <div>
            ...
            <input
              ...
              className="w-full border border-blue-200 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-400 text-black placeholder:text-gray-400"
          ...
          <div>
            ...
            <input
              ...
              className={`w-full border border-blue-200 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-400 
                ${form.birthDate === "" ? "text-gray-400" : "text-black"}`}
            />
          </div>
          ...
          <div>
            ...
            <select
              ...
              className={`w-full border border-blue-200 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-400 
              ${form.sex === "" ? "text-gray-400" : "text-blue-900"}`}>
          ...
          <div>
            ...
            <select
              ...
              className={`w-full border border-blue-200 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-400 
              ${form.status === "" ? "text-gray-400" : "text-blue-900"}`}>
